...
Color Alert 是 Windows 10/11 的輕量桌面工具。使用者可以框選最多 10 個監看區域；當區域中穩定出現指定黃色 `#CEB374`、藍色 `#6088C5`，或同色總面積明顯增加時，程式會播放 Windows 系統提示音。
...
4. 視需要分別調整顏色敏感度、面積敏感度、提示音次數與是否顯示監看區域。
5. 按「開始監看」。暫停／恢復會沿用各區域與顏色目前已確認的面積。
6. 目標色首次出現或相對上次確認面積再次增加並連續三次達標時會提示。
